...
int application::objects::bicameral_hyperboloid::prepare() {

    float a = 25.0;
    float b = 25.0;
    float c = 25.0;

    _transform.model = glm::scale(_transform.model, glm::vec3(0.01f, 0.01f, 0.01f));
...
int application::objects::bicameral_hyperboloid::draw() {
...
int application::objects::bicameral_hyperboloid::rotate() {
